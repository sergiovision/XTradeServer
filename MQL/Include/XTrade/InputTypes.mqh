...
INPUT_VARIABLE(retraceFactor, double)
INPUT_VARIABLE(symReversals, bool)
...
STORE_DBL_VARIABLE(retraceFactor, double, "retraceFactor", 1.0)
STORE_BOOL_VARIABLE(symReversals, bool, "symReversals", false)
