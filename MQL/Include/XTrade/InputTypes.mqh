...
INPUT_VARIABLE(retracementFactor, double)
INPUT_VARIABLE(symetricalReversals, bool)
INPUT_VARIABLE(InfoTextColor, long)
INPUT_VARIABLE(showWicks, bool)
//--------------------------------------------------------------------
...
STORE_DBL_VARIABLE(retracementFactor, double, "retracementFactor", 0.25)
STORE_BOOL_VARIABLE(symetricalReversals, bool, "symetricalReversals", true)
STORE_INT_VARIABLE(InfoTextColor, long, "InfoTextColor", (long)clrBlack)
STORE_BOOL_VARIABLE(showWicks, bool, "showWicks", true)
