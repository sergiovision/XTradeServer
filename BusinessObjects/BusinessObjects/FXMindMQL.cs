...
namespace BusinessObjects
{
    public class FXMindMQL
    {
        ...
        return oprot_.Transport.BeginFlush(callback, state);
            ...
            public List<string> recv_ProcessStringData()
            {
                ...
                throw new TApplicationException(TApplicationException.ExceptionType.MissingResult,
                    "ProcessStringData failed: unknown result");
            }
      ...
      public IAsyncResult send_ProcessDoubleData(AsyncCallback callback, object state, Dictionary<string, string> paramsList, List<string> inputData)
        ...
        return oprot_.Transport.BeginFlush(callback, state);
            ...
            public List<double> recv_ProcessDoubleData()
            {
                ...
                if (result.__isset.success) return result.Success;
                throw new TApplicationException(TApplicationException.ExceptionType.MissingResult,
                    "ProcessDoubleData failed: unknown result");
            }
      ...
      public IAsyncResult send_IsServerActive(AsyncCallback callback, object state, Dictionary<string, string> paramsList)
        ...
        return oprot_.Transport.BeginFlush(callback, state);
            ...
            public long recv_IsServerActive()
            {
                ...
                if (result.__isset.success) return result.Success;
                throw new TApplicationException(TApplicationException.ExceptionType.MissingResult,
                    "IsServerActive failed: unknown result");
            }
      ...
      public IAsyncResult send_PostStatusMessage(AsyncCallback callback, object state, Dictionary<string, string> paramsList)
        ...
        [Serializable]
#endif
        public class ProcessStringData_args : TBase
        {
            ...
            public void Write(TProtocol oprot)
            {
                ...
                if (InputData != null && __isset.inputData)
                {
                    ...
                    oprot.WriteFieldBegin(field);
                    {
                        ...
                        foreach (string _iter8 in InputData) oprot.WriteString(_iter8);
                        oprot.WriteListEnd();
                    }
                    oprot.WriteFieldEnd();
                }
        ...
        [Serializable]
#endif
        public class ProcessStringData_result : TBase
        {
            public Isset __isset;
                ...
                if (__isset.success)
                    if (Success != null)
                    {
                        ...
                        oprot.WriteFieldBegin(field);
                        {
                            ...
                            foreach (string _iter12 in Success) oprot.WriteString(_iter12);
                            oprot.WriteListEnd();
                        }
                        oprot.WriteFieldEnd();
                    }
        ...
        [Serializable]
#endif
        public class ProcessDoubleData_args : TBase
        {
            public Isset __isset;
            private List<string> _inputData;
            private Dictionary<string, string> _paramsList;
            ...
            public void Write(TProtocol oprot)
            {
                ...
                if (InputData != null && __isset.inputData)
                {
                    ...
                    {
                        oprot.WriteListBegin(new TList(TType.String, InputData.Count));
                        foreach (string _iter21 in InputData) oprot.WriteString(_iter21);
                        oprot.WriteListEnd();
                    }
                    oprot.WriteFieldEnd();
                }
        ...
        [Serializable]
#endif
        public class ProcessDoubleData_result : TBase
        {
            public Isset __isset;
                ...
                if (__isset.success)
                    if (Success != null)
                    {
                        ...
                        oprot.WriteFieldBegin(field);
                        {
                            ...
                            foreach (double _iter25 in Success) oprot.WriteDouble(_iter25);
                            oprot.WriteListEnd();
                        }
                        oprot.WriteFieldEnd();
                    }
        ...
        [Serializable]
#endif
        public class IsServerActive_args : TBase
        {
            public Isset __isset;
            private Dictionary<string, string> _paramsList;
        ...
        [Serializable]
#endif
        public class IsServerActive_result : TBase
        {
            public Isset __isset;
        ...
        [Serializable]
#endif
        public class PostStatusMessage_args : TBase
        {
            public Isset __isset;
            private Dictionary<string, string> _paramsList;
