...
rates = MT5CopyRatesFromPos( symbol, MT5_TIMEFRAME_M15, 0, count_rates)
...
train_index = int(count_rates * train_test_ratio)
split_date = pd.Timestamp(data.index.values[train_index])
